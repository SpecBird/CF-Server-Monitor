...
const translations = reactive({
  en: {
    ...
    cspWarning: 'When adding third-party CSS/JS, ensure the source is trustworthy. It is recommended to host resources on your own GitHub repository and use CDN to call. Incorrect usage may bring serious security risks. External resources need to be added to the CSP Static Domains whitelist above.',
    cspInvalidDomain: 'Invalid CSP domain format. Each domain must start with https://',
  ...
  zh: {
    ...
    cspWarning: '添加第三方 CSS/JS 时，请确保来源安全可靠。建议将资源托管在自己的 GitHub 仓库中，通过 CDN 调用。使用不当可能带来严重安全风险。外部资源需要添加到上方的 CSP 静态文件域名白名单中。',
    cspInvalidDomain: 'CSP 域名格式无效，每个域名必须以 https:// 开头',
    displayOptions: '显示选项',
    publicAccess: '公开访问',
    showPrice: '显示价格',
    showExpire: '显示到期时间',
